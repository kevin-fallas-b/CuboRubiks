...
/**
 * obtenido de https://stackoverflow.com/revisions/34005357/2, el cual a su vez
 * lo saco de http://docs.oracle.com/javafx/8/3d_graphics/sampleapp.htm
 *
...
public class Xform extends Group {
...

    {
        ...
        //rx.setAxis(localToScene(50.00, 50.00, 50.00));
    ...
    public Rotate rc = new Rotate();

    {
        rc.setAxis(new Point3D(1, 1, 1));
    }
    public Scale s = new Scale();

    public Xform() {
        super();
        getTransforms().addAll(t, rz, ry, rx, s,rc);
    }
    ...
    public String toString() {
        return "Xform[t = (" + t.getX() + ", " + t.getY() + ", " + t.getZ()
                ...
                + ", " + s.getZ() + ")  " + "p = (" + p.getX() + ", " + p.getY()
                + ", " + p.getZ() + ")  " + "ip = (" + ip.getX() + ", " + ip.getY()
                + ", " + ip.getZ() + ")]";
    }
}
